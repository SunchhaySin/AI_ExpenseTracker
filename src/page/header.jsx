...
export default function Header() {
    ...
    return (
        <header className={`w-full flex justify-between py-2 px-4 ${isLoggedIn && "border-b border-(--bg2)/50 rounded-2xl"} `}>
            {/* Date/Time */}
            <div
            ...
            <div className={`flex ${windowWidth > 600 ? "gap-4" : "gap-2"} items-center justify-between`}>
                {/* Dark/Light Mode */}
                    ...
                    <div className="flex-1 flex gap-2 items-center justify-end text-(--text)">
                        ...
                        {windowWidth > 750 ? (
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    onClick={windowWidth > 1275
                                        ? () => setIsOpenConversion(!isOpenConversion)
